...
function nextIdSync(data, table) {
...
module.exports = {
  mode: 'json',
  dbPath,
  load: () => Promise.resolve(loadSync()),
  save: (data) => Promise.resolve(saveSync(data)),
  nextId: (data, table) => Promise.resolve(nextIdSync(data, table)),
  loadSync,
  saveSync,
  nextIdSync,
};
